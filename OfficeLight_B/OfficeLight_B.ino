...
int old_st1 = 0, old_st2 = 0, old_st3 = 0, old_st4 = 0, old_st5 = 0, old_st6 = 0;
int cur_st1 = 0, cur_st2 = 0, cur_st3 = 0, cur_st4 = 0, cur_st5 = 0, cur_st6 = 0;
...
bool CSread(CapacitiveSensor &capaSence) {
  ...
  Serial.println(cs);
  if (cs>= 90) //c: This value is the threshold, a High value means it takes longer to trigger
  {
